define([
        './module-business-constructors.js'
    ],
    function(Business) {
        return function() {
            var api = null;
            ...
            var templates = {
                getDataItem: function(un) {
                    return {
                        cfg: fillUniq({
                            ...
                            list: [
                                {type: 'button', name: templateKeys.deleteDataBtn, value: '', className: 'delete-item'},
                                {type: 'newcolumn'},
                ...
                getPathItem: function(un) {
                    return {
                        cfg: fillUniq({
                            ...
                            list: [
                                {type: 'button', name: templateKeys.deletePathBtn, value: '', className: 'delete-item'},
                                {type: 'newcolumn'},
                                {type: 'block', width: 395, list: [
                ...
                getSelectorItem: function(parentUn, un, isFirst) {
                    return {
                        cfg: fillUniq({
                            ...
                            list: [
                                {type: 'input', name: 'selector', label: isFirst? 'Selector': '', inputWidth: 300},
                                {type: 'newcolumn'},
                                isFirst
                ...
                _getItemHandlers: function() {
                    return [
                        ...
                        {value: 'attr', text: 'Attribute Value'},
            ...
            function initForm(container, index) {
                ...
                initFormBRules(vForm);
                return vForm;
            }

            function initFormBRules(form) {
                var brules = {};
                form.addBRules({
                    //ADD SELECTOR
            ...
            function updateDataByMapping(entity, unKeys, type) {
                ...
                if (mappings && mappings.length) {
                    filledMappings = fillMappings(mappings, unKeys);
                    form.fillEntity(entity, mappings, formData);
                }
            }

            api = {
                init: function(container, index, withDefaultState) {
